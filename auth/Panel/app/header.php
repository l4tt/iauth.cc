...
<body>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar" style="background-color: #343a40;">
			<div class="sidebar-content" style="background-color: #343a40;"s>
          ...
          <span class="align-middle">iAuth Panel</span>
              ...
              <i class="align-middle" data-feather="sliders" style="background-color: #343a40;"></i> <span class="align-middle">Dashboard</span>
						...
						<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar" style="background-color: #343a40;">
							<li class="sidebar-item active"><a style="background-color: #343a40;" class="sidebar-link" href=""><i  data-feather="box" style="color: #fffff;"></i>Apps</a></li>
							<li class="sidebar-item"> <a style="background-color: #343a40;" class="sidebar-link" href="keys/"><i  data-feather="key" style="color: #fffff;"></i>Licenses</a></li>
