...
<head>
  ...
  <meta property="twitter:card" content="summary_large_image">
	...
	<link href="../../app_assets/libs/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
	<!-- END SETTINGS -->
	...
	<div class="wrapper">
          ...
          <span class="align-middle">iAuth Panel</span>
              ...
              <i class="align-middle" data-feather="sliders" style="background-color: #343a40;"></i> <span class="align-middle">Dashboard</span>
						...
						<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-parent="#sidebar" style="background-color: #343a40;">
							<li class="sidebar-item"><a style="background-color: #343a40;" class="sidebar-link" href="../"><i  data-feather="box" style="color: #fffff;"></i>Apps</a></li>
							<li class="sidebar-item active"> <a style="background-color: #343a40;" class="sidebar-link" href=""><i  data-feather="key" style="color: #fffff;"></i>Licenses</a></li>
							<li class="sidebar-item"><a style="background-color: #343a40;" class="sidebar-link" href="../users"><i  data-feather="users" style="color: #fffff;"></i>Users</a></li>
							<li class="sidebar-item"><a  style="background-color: #343a40;" class="sidebar-link" href="../blacklist"><i  data-feather="user-x" style="color: #fffff;"></i>Blacklist</a></li>
        ...
        <div class="main" style="background-color: #212529;">
          ...
          <i class="hamburger align-self-center"></i>
              ...
              <i class="align-middle <?php if($_SESSION['role'] == 'Vip' || $_SESSION['role'] == 'Premium') { echo "rankprem";} else { echo "basic";} ?>" style=" !important; margin-left: 10px;" data-feather="shield"></i> <span  class="text-light text-bold"><?php echo htmlspecialchars($_SESSION['role']);?></span>
